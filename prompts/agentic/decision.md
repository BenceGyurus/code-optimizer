...
- `propose_change` expects `args.target`, `args.strategy`, `args.patch`, and `args.rationale`. When a safe patch exists, `args.patch` should be a unified diff beginning with `diff --git`.
