...
A program elkészítéséhez használtam többfajta model-t valamint több forájában is használtam őket mint CLI-ben, web-en keresztül valamint desktop alkalmazásban. A tervezéshez a web-es chatGPT-t használtam a ChatGPT 5.4-es model-el. Ezt azért találtam a legmegfelelőbbnek hiszen nagyon nagy az output kontextusa, így a végleges követelményrendszert egyben le tudtam vele iratni. Úgy kezdtem, hogy felvázoltam neki a koncepciót, hogy mit szeretnék készíteni, hogyan képzelem el és utána ezt ő véleményezte és lényegében közösen gondolkodtunk, hogy hogyan lenne a lehető legmegfelelőbb a megvalósítás majd a legvégén a korábbi beszélgetés alapján megirattam vele a végleges követelményrendszert és amit kiírt azt beadtam a GeminiCLI-nak (Automatikus model használat amiben Gemini 3.1 pro és Gemini 3 fast van), hogy valósítsa meg. Neki valószínüleg ez a kontextus és maga a feladat is egyben túl nagy volt, hiszen csak a követelmények egy tördékét valósította meg, azok sem feltétlen működtek az elvárásnak megfelelően, így a a korábban beadott szöveget ugyanúgy beadtam a Codex-nek, itt már ChatGPT 5.4 és ChatGPT 5.5-öt is használtam. A Codex csinált egy check list-et róla, hogy mik azok a lépések amiket meg kell csinálnia és elkészített egy demo programot. Ennek a futtásnam a kimenete sem volt tökéletes korántsem viszont már egy futtatható változat volt, így volt miből kiindulni, ekkor néhány futtatás közösen elemezve mindig új funkcióval bővítette vagy javított a programot. Alapvetően az az észrevételem, hogy sokkal pontosabban oldja meg a feladatot ha előbb megkérem, hogy csak tervezze meg, majd ha ez az elvárásnak megfelel utána mondom, hogy valósítsa meg akkor sokkal pontosabban csinálja meg az adott feladatot és általában hibátlanul vagy utána kevesebbet kell korrigálni. 
