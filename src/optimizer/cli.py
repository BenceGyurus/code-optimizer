...
def run(
    ...
    function_profile_command: Optional[str] = typer.Option(None, "--function-profile-command", help="Function profiler command, for example cProfile."),
    ...
    function_profile_repetitions: int = typer.Option(1, "--function-profile-repetitions", help="Function profiler repetitions."),
